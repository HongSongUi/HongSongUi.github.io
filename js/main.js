...
const translations = {
    ko: {
		...
		major_name:"컴퓨터 공학",
		University_content: "4년 간 프로그래밍에 관한 지식을 쌓고 프로젝트를 수행하며 기초를 익혀왔습니다",
		name2 : "KGCA 게임 아카데미",
		procedure: "게임 프로그래머 과정",
		content2 : "게임 수학과 DirectX, Unreal Engine을 배우며 프로젝트를 통해 게임 프로그래머로서 성장하였습니다.",
		projects_content: "여러가지 프로젝트를 진행하며, 게임 프로그래머로서 경험을 쌓아왔습니다.",
    ...
    jp: {
		...
		University_content: "4年間プログラミングに関する知識を積み、プロジェクトを遂行しながら基礎を身につけました。",
		name2 : "KGCAゲームアカデミー",
		procedure: "ゲームプログラマーの過程",
		content2:"ゲーム数学とDirectX、Unreal Engineを学び、プロジェクトを通じてゲームプログラマーとして成長しました。",
		projects_content : "様々なプロジェクトを通して、ゲームプログラマーとして経験を積んできました。",
		...
		game_content1 : "モンスターたちが竜の卵を盗むために打ち込んできました！ 竜の卵は7日後には孵化し、それまで敵の攻撃を防がなければなりません。 様々な竜との組み合わせで敵の攻撃を防御し、竜の卵を安全に守り孵化させましょう！",
		game_content2 : "このゲームはロックマンX5のダイナモとの戦闘を再現した作品で、原作のダイナミックな戦闘スタイルと攻撃パターンを忠実に再現しました。 プレイヤーは緊張感あふれる戦闘を体験できます。",
		game_content3 : "このゲームはアンリアルエンジンを使用してブループリントのみで製作された戦闘ゲームです。 プレイヤーはパイロットになり、敵のミサイルを避けながら、敵を撃退して戦闘を行います。 目標は任務を果たし、無事に空母に帰還することです。",
		game_content4 : "このゲームはアンリアルエンジンを使用して製作されたモンスターハンターワールドの模作で、リオレウスとの戦闘を再現したプロジェクトです。",
		game_content5 : "このゲームはアンリアルエンジンを使用して製作されたシューティングベースのバトルロイヤルマルチプレイゲームです。 ローグライク要素が追加され、プレイヤーはモンスターを倒し、レベルを上げることでスキルを選択できます。 最終目標は戦闘で最後まで生き残って勝利することです。",
		screen1 : "個人画面",
		screen2 : "個別プレーヤー画面",
