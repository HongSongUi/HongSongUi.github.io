...
const translations = {
    ...
    jp: {
		...
		University_content: "4年間プログラミングに関する知識を積み、プロジェクトを遂行しながら基礎を身につけてきました。",
		name2 : "KGCAゲームアカデミー",
		procedure: "ゲームプログラマーの過程",
		content2:"ゲーム数学とDirectX、Unreal Engineを学び、プロジェクトを通じてゲームプログラマーとして成長しました。",
		projects_content : "様々プロジェクトを通して、ゲームプログラマーとして経験を積んできました。",
		...
		game_content5 : "このゲームはアンリアルエンジンを使用して製作されたシューティングベースのバトルロイヤルマルチプレイゲームです。 ローグライク要素が追加され、プレイヤーはモンスターを処置し、レベルを上げることでスキルを選択できます。 最終目標は戦闘で最後まで生き残って勝利することです。",
		screen1 : "個人画面",
		screen2 : "個別プレーヤー画面",
